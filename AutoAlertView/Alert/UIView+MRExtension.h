...
@property(nonatomic, assign)CGFloat mr_right;

@property (nonatomic, assign)CGFloat mr_left;
@property (nonatomic, assign)CGFloat mr_top;
@property (nonatomic, assign)CGFloat mr_bottom;
